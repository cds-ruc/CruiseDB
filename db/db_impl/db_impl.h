...
class DBImpl : public DB {
 ...
 protected:
  ...
  Status TbBegin(ColumnFamilyHandle* column_family, int code);
 ...
 private:
  ...
  static void BGWorkManualCompaction(void* arg);
  static void BGWorkFlush(void* arg);
  static void BGWorkPurge(void* arg);
  static void UnscheduleCompactionCallback(void* arg);
  static void UnscheduleFlushCallback(void* arg);
  static void UnscheduleManualCompactionCallback(void* arg);
  void BackgroundCallCompaction(PrepickedCompaction* prepicked_compaction,
                                Env::Priority thread_pri);
  void BackgroundCallFlush(Env::Priority thread_pri);
  void BackgroundCallManualCompaction();
  ...
  int bg_manual_compaction_scheduled_;
